...
net_params = NetParams(
    template={
        ...
        "net": os.path.join(ow_dir, "scenario/lust.net.xml"),
        # features associated with the properties of drivers
        "vtype": os.path.join(ow_dir, "scenario/vtypes.add.xml"),
        # features associated with the routes vehicles take
        "rou": [os.path.join(ow_dir, "scenario/DUARoutes/local.0.rou.xml"),
                os.path.join(ow_dir, "scenario/DUARoutes/local.1.rou.xml"),
                os.path.join(ow_dir, "scenario/DUARoutes/local.2.rou.xml")]
    }
)
